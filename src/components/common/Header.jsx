        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <motion.div 
              ...
              whileTap={{ scale: 0.95 }}
            >
              <button className="flex items-center space-x-2 p-1 rounded-full bg-gray-700/50 hover:bg-gray-600/50 transition-colors">
                ...
                <span className="text-sm font-medium text-gray-200 pr-2 hidden md:block">Admin</span>
              </button>
            </motion.div>
          </div>
        </div>
