import { MonitorIcon as MonitorCog, Users, Cctv, DollarSign, ShoppingCart, Settings, Menu, ChevronRight, LogOut, HelpCircle } from 'lucide-react';
...
const SIDEBAR_ITEMS = [
  ...
  { name: 'View', icon: Cctv, color: '#10B981', href: '/view' },
                    ...
                    >
                      <div 
                        className={`flex items-center justify-center h-8 w-8 rounded-lg ${
                          isActive ? 'bg-gradient-to-r from-blue-500/20 to-cyan-400/20' : 'bg-gray-700/30'
                        }`}
                      >
